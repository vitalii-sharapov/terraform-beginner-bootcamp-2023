...
- Environment Variables - Those you'd set in your bash terminal eg. AWS Credentials
- Terraform Variables - those that you'd nomally set in your tfvars file
...
They are not recommended for use by Hashicorp because Configuration Management tools such as Ansible is a better fit, but the functionality exists.
...
[Terraform Local Exec Documentation](https://developer.hashicorp.com/terraform/language/resources/provisioners/local-exec)
